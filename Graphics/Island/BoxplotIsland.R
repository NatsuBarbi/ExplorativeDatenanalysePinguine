...
ggplot(data_Biscoe, aes(y=body_mass_g)) +
  ...
  scale_x_discrete() +
  coord_flip() +
  labs(y="Gewicht in gramm", title="Gewichtsverteilung Biscoe") +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(data_Dream, aes(y=body_mass_g)) +
  ...
  scale_x_discrete() +
  coord_flip() +
  labs(y="Gewicht in gramm", title="Gewichtsverteilung Dream") +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(data_Torgersen, aes(y=body_mass_g)) +
  ...
  scale_x_discrete() +
  coord_flip() +
  labs(y="Gewicht in gramm", title="Gewichtsverteilung Torgersen") +
  theme(plot.title = element_text(hjust = 0.5))